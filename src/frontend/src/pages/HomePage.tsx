            ...
            <div className="absolute inset-0 bg-gradient-to-r from-foreground/60 via-foreground/20 to-transparent flex items-center px-8">
              <div>
                ...
                <p className="text-white/75 text-sm mt-2 max-w-xs">
                  Pilih topik atau ambil kuiz penuh untuk menguji pemahaman
                  anda.
                </p>
              </div>
            </div>
      ...
      <main className="flex-1 w-full max-w-5xl mx-auto px-4 py-8">
        <div className="mb-6">
          ...
          <p className="text-muted-foreground text-sm">
            Pilih satu topik untuk fokus, atau ambil <strong>Kuiz Penuh</strong>{" "}
            yang merangkumi semua soalan.
          </p>
        </div>
