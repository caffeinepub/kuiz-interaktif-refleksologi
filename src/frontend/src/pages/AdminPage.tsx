...
function getPercentageBadgeVariant(
  percentage: number,
      ...
      >
        ...
        >
          <tbody>
            <tr>
              <td
                style={{ padding: "3pt 0", fontWeight: "bold", width: "120pt" }}
              >
                Nama
              </td>
...
export default function AdminPage() {
  ...
  const [selectedParticipant, setSelectedParticipant] = useState<Result | null>(
    null,
  );
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 w-full max-w-5xl mx-auto px-4 py-8">
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 text-center">
            <p className="text-error text-base mb-3">
            ...
            <Table>
              ...
              <TableBody>
                {results.map((result, index) => {
                  ...
                  return (
                    <TableRow
                      // biome-ignore lint/suspicious/noArrayIndexKey: rank order is deterministic
                      key={index}
                      className={cn(
                        "transition-colors",
                    ...
                    >
                      ...
                      <TableCell className="hidden md:table-cell">
                        <Badge
                          variant="outline"
                          className="text-xs text-primary border-primary/30 bg-primary/5 font-normal"
                        >
                          {result.topic}
                        </Badge>
                      </TableCell>
      ...
      <div ref={printCardRef} aria-hidden="true">
        {selectedParticipant && <PrintCard participant={selectedParticipant} />}
      </div>
      ...
      <footer className="w-full border-t border-border bg-card mt-auto">
        <div className="max-w-5xl mx-auto px-4 py-5 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-muted-foreground">
          <span>
            © {new Date().getFullYear()} Kuiz Refleksologi. Hak cipta
            terpelihara.
          </span>
