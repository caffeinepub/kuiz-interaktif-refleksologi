...
function getPerformance(percentage: number) {
  ...
  if (percentage >= 70) {
    return {
      label: "Bagus!",
      message:
        "Prestasi yang baik! Teruskan usaha untuk mencapai yang lebih tinggi.",
      icon: TrendingUp,
    ...
    <div className="animate-scale-in flex flex-col items-center text-center max-w-lg mx-auto py-4">
      ...
      <div className="w-full bg-card rounded-2xl border border-border shadow-xs p-5 mb-6">
        <div className="grid grid-cols-3 gap-4 text-center">
          ...
          <div>
            <p className="text-2xl font-bold font-serif text-error">
              {total - score}
            </p>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-muted/50 border-b border-border">
                  <th className="text-left px-3 py-2 text-xs font-semibold text-muted-foreground w-8">
                    #
                  </th>
                        ...
                        >
                          {isCorrect ? (
                            <>
                              ...
                              <span className="hidden sm:inline">Betul</span>
                            </>
                          ) : (
                            <>
